...
?>
		...
		<a href="<?php echo $result['ln'];?>" target="_blank"><img src="images/tw.png" alt="Twitter"/></a>
		<a href="<?php echo $result['tw'];?>" target="_blank"><img src="images/in.png" alt="LinkedIn"/></a>
